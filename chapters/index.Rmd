...
This toolkit requires familiarity with the `R` programming language and the use of `R` for working with, visualizing, and analyzing scientific data. The toolkit chapter [Getting Started](#chapter-getting-started) provides a list of resources for getting started with `R`.
