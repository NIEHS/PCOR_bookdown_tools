...
Coordinate reference systems (CRS) are important for spatial analyses as they define how spatial data align with the Earth's surface.\cite{geocomputation-24} Transforming (projecting) the data to a different CRS may be necessary when combining multiple datasets or creating visuals for particular areas of interest. It is important to note that transforming spatial data can cause distortions in it's area, direction, distance, or shape.\cite{geocomputation-24} The direction and magnitude of these distortions vary depending on the chosen CRS, area of interest, and type of data.\cite{article_steinwand1995reprojection} For guidance on selected the right coordinate reference system based on the data, area of interest, and analysis goals, see [Choose the right projection](https://learn.arcgis.com/en/projects/choose-the-right-projection/).\cite{arcgis-crs}
