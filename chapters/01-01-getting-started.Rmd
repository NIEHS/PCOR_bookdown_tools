...
1. Introduce concepts and terminology used throughout the CHORDS Toolkit for geospatial data and geospatial analysis methods. 2. Describe the public geospatial datasets and `R` packages used in the following tutorials.
3. Provide a list of other useful resources for getting started with geospatial data analysis in environmental health using `R`.
