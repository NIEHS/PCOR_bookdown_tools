...
These tutorials will cover how to access, import, and analyze different types of spatial data: point, polygon, and raster spatial data types. For detailed descriptions of each type, please see [Simple Features for R](https://r-spatial.github.io/sf/articles/sf1.html) [@r-sf-1] and [Introduction to Raster Data](https://datacarpentry.org/organization-geospatial/01-intro-raster-data) [@raster-data] for raster data.
