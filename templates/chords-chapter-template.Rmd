...
1. Add the BibTex reference information for the resource to the file `book.bib`. For example, the BibTex reference information for the `R` package `terra` looks like this:
