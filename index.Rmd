...
This resource does assume a familiarity with the `R` programming language and the use of `R` for working with, visualizing, and analyzing scientific data.

The [TAME Toolkit](https://uncsrp.github.io/Data-Analysis-Training-Modules/) provides a good resource for gaining familiarity with `R` for use in environmental health research methods, in particular Chapter 1 on Introductory Data Science and Chapter 3.3 on Database Integration.  
