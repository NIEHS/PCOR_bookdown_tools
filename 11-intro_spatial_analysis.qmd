...
:::{layout-ncol=3}
![Clinical Researcher](images/user_profiles/lab_coat_goggles.png){width="150"}

![Epidemiology Researcher](images/user_profiles/doctor_glasses.png){width="150"}

![Student](images/user_profiles/students.png){width="150"}
:::
