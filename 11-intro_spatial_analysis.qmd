...
Various R packages can be used to create, import, analyze, and export spatial data. If you have not used these packages previously, they may not be installed on your machine. The following of code installs and imports the packages required to conduct the exploratory analyses in this vignette.
...
To download data with the `utils::download.file()` function, define two variables to store the website URL where the data exists and the file path for where the file should be saved.
