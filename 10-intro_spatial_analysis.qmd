...
test_that("State boundary shapefile exists.", {
  files <- list.files("/Volumes/manwareme/PCOR_bookdown_tools/dataset/states/")
...
test_that("Required packages are imported.", {
  loaded_packages <- library()
  loaded_packages <- loaded_packages$results[,1]
