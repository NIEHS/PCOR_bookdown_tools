...
library(ggpubr)
map <- st_read(
  paste0("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/states/",
...
url_epa <- "https://aqs.epa.gov/aqsweb/airdata/daily_88101_2021.zip"
destination_epa <-
  "/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/epa/epa_data.zip"
download.file(
  url_epa,
  destination_epa
)
...
```{r, echo=FALSE}
################################################################################
unzip("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/epa/epa_data.zip",
  list = TRUE
)
################################################################################
```
...
```{r, echo=FALSE}
################################################################################
list.files("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/epa")
################################################################################
```
...
################################################################################
pm <- st_read(
  paste0("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/epa/",
...
destination_noaa <- paste0(
  "/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/noaa/noaa_smoke",
  year,
  month,
  day,
  ".zip"
...
################################################################################
unzip(
  paste0("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/noaa/",
         "noaa_smoke20230901.zip"),
  list = TRUE
)
################################################################################
```
...
```{r, echo=FALSE}
################################################################################
list.files("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/noaa")
################################################################################
```
...
url_states <-
  "https://www2.census.gov/geo/tiger/GENZ2018/shp/cb_2018_us_state_500k.zip"
destination_states <-
  "/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/states/states.zip"
download.file(
  url_states,
  destination_states
)
...
## NEED TO CHANGE eval=TRUE for rendering
################################################################################
unzip("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/states/states.zip",
  list = TRUE
)
################################################################################
```
...
################################################################################
unzip("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/states/states.zip",
  exdir = "/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/states"
)
################################################################################
```
...
```{r, echo=FALSE}
################################################################################
list.files("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/states")
################################################################################
```
...
destination_narr <- paste0(
  "/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/narr/narr_air2m_",
  year,
  ".nc"
)
download.file(
...
```{r, echo=FALSE}
################################################################################
list.files("/Volumes/manwareme/home/PCOR_bookdown_tools/datasets/narr")
################################################################################
```
